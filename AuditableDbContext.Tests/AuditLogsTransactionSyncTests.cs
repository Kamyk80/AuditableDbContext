...
public class AuditLogsTransactionSyncTests : AuditLogsBaseTests
{
    ...
    private static MsSqlContainer _database = null!;
    ...
    public static async Task TestFixtureSetup(TestContext _)
    {
        ...
        _options = BuildContextOptions(_database);
    ...
    [TestInitialize]
    public void TestSetup() => Options = _options;

    [ClassCleanup]
    public static async Task TestFixtureTearDown() => await _database.StopAsync();
}